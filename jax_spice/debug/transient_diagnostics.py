"""Transient simulation diagnostics for JAX-SPICE.
...
Usage:
    from jax_spice.debug import parse_debug_output, capture_step_trace
...
@dataclass
class StepRecord:
    """One parsed step from JAX-SPICE debug_steps output."""
