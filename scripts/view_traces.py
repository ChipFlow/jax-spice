...
Usage:
    ...
    uv run scripts/view_traces.py /tmp/vajax-traces

    # Download and view traces from GCS
    uv run scripts/view_traces.py --gcs gs://vajax-cuda-test-traces/abc123
"""
...
CACHE_DIR = Path.home() / ".cache" / "vajax-traces"
GCS_BUCKET = "vajax-cuda-test-traces"
...
def main():
    ...
    if not trace_dir.exists():
        ...
        print("  VAJAX_PROFILE_JAX=1 uv run python scripts/compare_vacask.py --profile")
        print()
    ...
    print("=" * 60)
    print("VAJAX Profiling Trace Viewer")
    print("=" * 60)
    print()
