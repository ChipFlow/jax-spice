...
def main():
    ...
    print("=" * 60)
    print("VAJAX nsys-jax GPU Profiling on Cloud Run")
    print("=" * 60)
...
# Clone repo at main
git clone --depth 1 --recurse-submodules https://github.com/ChipFlow/vajax.git source
cd source
